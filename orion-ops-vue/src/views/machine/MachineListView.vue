      ...
      <div class="table-tools-bar">
        ...
        <div class="tools-fixed-left">
          ...
          <div v-show="selectedRowKeys.length" class="batch-actions">
            <a-popconfirm title="是否要启用选中机器?"
              ...
              <a-button type="primary" icon="build" size="small">启用</a-button>
            </a-popconfirm>
            <a-popconfirm title="是否要停用选中机器?"
              ...
              <a-button type="primary" icon="fork" size="small">停用</a-button>
            </a-popconfirm>
        ...
        <div class="tools-fixed-right">
          <a target="_blank" href="#/machine/terminal">
            <a-button type="primary" icon="desktop" class="action-btn">Terminal</a-button>
          </a>
          <a-button type="primary" icon="plus" @click="openAdd" class="action-btn">新建机器</a-button>
            ...
            <a-dropdown>
              ...
              <template #overlay>
                <a-menu @click="menuHandler($event, record)">
                  ...
                  <a-menu-item v-if="record.id !== 1" key="delete">删除</a-menu-item>
                  <a-menu-item key="copy">复制</a-menu-item>
                  <a-menu-item key="ping" v-if="record.status === 1">ping</a-menu-item>
                  <a-menu-item key="connect" v-if="record.status === 1">测试连接</a-menu-item>
                  <a-menu-item key="bindKey" v-if="record.authType === MACHINE_AUTH_TYPE.SECRET_KEY.value">绑定密钥</a-menu-item>
