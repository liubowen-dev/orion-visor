    ...
    <div class="table-wrapper">
      ...
      <div class="table-tools-bar">
        ...
        <div class="tools-fixed-right">
          <a-button v-if="query.profileId" type="primary" icon="plus" @click="add" class="action-btn">新建</a-button>
        ...
        <a-table :columns="columns"
          ...
          <template #action="record">
            <div class="table-actions">
              <span class="action-link" @click="execPipeline(record.id)">执行</span>
              <a-divider type="vertical" class="action-divider" />
              <span class="action-link" @click="openDetail(record.id)">详情</span>
              <a-divider type="vertical" class="action-divider" />
              <span class="action-link" @click="update(record.id)">配置</span>
              <a-divider type="vertical" class="action-divider" />
...
export default {
  ...
  methods: {
    ...
    remove(idList) {
      this.$api.deleteAppPipeline({ idList }).then(() => {
        this.selectedRowKeys = []
