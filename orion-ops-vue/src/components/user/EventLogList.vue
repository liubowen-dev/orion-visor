...
const columns = [
  { title: '操作描述', key: 'log', scopedSlots: { customRender: 'log' } },
  { title: '操作分类', key: 'classify', width: 130, scopedSlots: { customRender: 'classify' } },
  { title: '操作类型', key: 'type', width: 130, scopedSlots: { customRender: 'type' } },
  { title: '操作用户', key: 'username', width: 130, scopedSlots: { customRender: 'username' } },
  { title: '操作IP', key: 'ip', width: 150, scopedSlots: { customRender: 'ip' } },
  { title: '操作时间', key: 'time', width: 160, scopedSlots: { customRender: 'time' } },
  { title: '操作', key: 'action', fixed: 'right', width: 80, align: 'center', scopedSlots: { customRender: 'action' } }
]
